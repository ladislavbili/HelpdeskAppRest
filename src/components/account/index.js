  ...
  render() {
    return (
      <Container>
        ...
        <Button danger block onPress={()=>{this.props.logoutUser();Actions.login()}} iconLeft style={{ flexDirection: 'row', borderColor: 'white', marginTop:5, marginBottom:20, borderWidth: 0.5 }}>
